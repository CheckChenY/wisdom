...
class AddShareUser extends Component {
    constructor() {
        super()
        this.state = {
            code:'',
    ...
    render() {
        return (
            <View style={style.page}>
                ...
                <TouchableOpacity onPress={()=>{this.checkuser()}} style={{height:45,backgroundColor:'#467cd4',justifyContent:'center',alignItems:'center',position:'absolute',bottom:0,left:0,right:0,}}>
    ...
    checkuser=()=>{
        this.props.navigation.navigate('checkuser')
    }
    onChangeJointype=()=>{
