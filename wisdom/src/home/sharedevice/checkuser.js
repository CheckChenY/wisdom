            ...
            <View style={style.page}>
                <View style={{flexDirection:'row',paddingLeft:15,paddingRight:15,backgroundColor:'#fff',}}>
                    ...
                    <View style={{justifyContent:'center'}}>
                        <Text style={{fontSize:16,color:'#333',}}>XX用户名</Text>
                        <Text style={{fontSize:14,color:'#888',marginTop:5,}}>手机号：18595838670</Text>
                    </View>
                </View>
                <TouchableOpacity onPress={()=>{this.addtag()}} style={{height:45,backgroundColor:'#467cd4',justifyContent:'center',alignItems:'center',position:'absolute',bottom:0,left:0,right:0,}}>
