    ...
    <div v-if="showindex=='monitoring'">
      ...
      >
        ...
        <template slot-scope="scope" slot="menu">
          ...
          <el-button size="mini" type="warning" plain icon="el-icon-setting" @click="remotedoit(scope)" v-if="scope.row.deviceType==41 || 
                                                                                                              scope.row.deviceType==20 ||
                                                                                                              scope.row.deviceType==21 ||
                                                                                                              scope.row.deviceType==22 ||
                                                                                                              scope.row.deviceType==23 ||
                                                                                                              scope.row.deviceType==24 ||
                                                                                                              scope.row.deviceType==25">远程操作</el-button>
        </template>
      </avue-crud>
      <!-- 设备类型弹窗 -->
                  ...
                  <el-main>
                    <el-row>
                      <el-col :span="12">
                        ...
                        <div class="grid-content">
                          <span class="input_label">三相电压值:</span>
                          <div class="avatar-uploader">
                      ...
                      <el-col :span="12">
                        ...
                        <div class="grid-content">
                          <span class="input_label">三相电流值:</span>
                          <div class="avatar-uploader">
...
import electricfire from "./electricfire.js";
export default electricfire;
</script>
<style lang="scss">
@import "./electricfire.scss";
