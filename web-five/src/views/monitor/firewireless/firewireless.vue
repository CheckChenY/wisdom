<template>
  <div class="fire_alarm">
      ...
      <span v-else-if="type.prop==='tab1'">
        ...
        >
          ...
          <template slot-scope="scope" slot="menu">
            ...
            >查看</el-button>
            <el-button size="mini" type="warning" plain icon="el-icon-setting" @click="remotedoit(scope)" v-if="scope.row.deviceType==26">远程操作</el-button>
          </template>
        </avue-crud>
        <!-- 设备类型弹窗 -->
    ...
    <deviceremote @handleClose="remoteOperationClose" :operaObj="setData" v-if="remoteOperationShow"/>
    <device-detail-dialog @handleClose="handleClose" v-if="deviceDetailShow" :setPropsId="setData"></device-detail-dialog>
  </div>
</template>

<script>
import firewireless from "./firewireless.js";
