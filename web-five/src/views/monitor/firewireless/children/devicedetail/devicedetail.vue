    ...
    <el-dialog title="设备详情" :visible.sync="dialogVisible" width="60%" :before-close="handleClose">
      <basic-container>
        ...
        <span v-else-if="type.prop==='tab2'">
          <el-container class="contain_scroll is-vertical" v-if="discribution.createTime">
            <el-main>
              <el-row>
                <el-col :span="12">
                  <div class="grid-content">
        ...
        <span v-else-if="type.prop==='tab4'">系统升级中</span>
      ...
      <el-dialog width="30%" title="请输入修改验证密码" :visible.sync="passwordShow" append-to-body>
