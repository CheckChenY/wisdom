            ...
            <el-main>
              <el-row>
                <el-col class="c_remote_left_instructions" :span="4">
                    <span class="c_remote_left_word">操作说明：</span>
                </el-col>
              ...
              <el-row class="c_remote_top_instructions">
                ...
                <el-col :span="20">
                    <el-button size="medium" plain v-for="(item,index) in OperationList" @click="mute(item)" :key="index">{{item}}</el-button>
                    <!-- <el-button plain size="medium" @click="mute">消音</el-button>
                    <el-button plain size="medium">复位</el-button>
                    <el-button plain size="medium">断电</el-button> -->
                </el-col>
              </el-row>
              <el-row class="c_remote_top_instructions" v-if="percentage">
                <el-col class="c_remote_left_instructions" :span="4">
                  操作进度：
                </el-col>
                <el-col :span="20">
                  <el-progress :stroke-width="15" :percentage="percentage" status="success" style="margin-top:5px;"></el-progress>
                </el-col>
              </el-row>
            </el-main>
          </el-container>
