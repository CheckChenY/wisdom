    ...
    <div v-if="showindex=='monitoring'">
      ...
      <div class="electric_dialog">
        <div class="electric_look device_dialog">
                  ...
                  <el-main>
                    <el-row>
                      <el-col :span="12">
                        ...
                        <div class="grid-content">
                          <span class="input_label">三相电压:</span>
                          <div class="avatar-uploader">
                            <span class="input_content" :class="[(discribution.warnState == 1 || discribution.warnState == 3) ? 'red':'',discribution.warnState == 2 ? 'yellow':'']">{{deviceParams.type3}}</span>
                          </div>
                        </div>
                        <div class="grid-content">
                          <span class="input_label">电压报警阈值:</span>
                          <div class="avatar-uploader">
                            <span class="input_content">{{deviceParams.type131}}</span>
                          </div>
                        </div>
                        <div class="grid-content">
                          <span class="input_label">漏电电流:</span>
                          <div class="avatar-uploader">
                            <span class="input_content" :class="[(discribution.warnState == 1 || discribution.warnState == 3) ? 'red':'',discribution.warnState == 2 ? 'yellow':'']">{{deviceParams.type1}}</span>
                          </div>
                        </div>
                        <div class="grid-content">
                          <span class="input_label">漏电阈值:</span>
                          <div class="avatar-uploader">
                            <span class="input_content">{{deviceParams.type129}}</span>
                          </div>
                        </div>
                      </el-col>
                      <el-col :span="12">
                        <div class="grid-content">
                          ...
                          <div class="avatar-uploader">
                            <span class="input_content" :class="[(discribution.warnState == 1 || discribution.warnState == 3) ? 'red':'',discribution.warnState == 2 ? 'yellow':'']">{{deviceStatusList.filter(res => res.value == discribution.warnState)[0]?deviceStatusList.filter(res => res.value == discribution.warnState)[0].label:'无'}}</span>
                          </div>
                        </div>
                        <div class="grid-content">
                          <span class="input_label">三相电流:</span>
                          <div class="avatar-uploader">
                            <span class="input_content" :class="[(discribution.warnState == 1 || discribution.warnState == 3) ? 'red':'',discribution.warnState == 2 ? 'yellow':'']">{{deviceParams.type4}}</span>
                          </div>
                        </div>
                        <div class="grid-content">
                          <span class="input_label">电流过载阈值:</span>
                          <div class="avatar-uploader">
                            <span class="input_content">{{deviceParams.type132}}</span>
                          </div>
                        </div>
                        <div class="grid-content">
                          <span class="input_label">四路温度:</span>
                          <div class="avatar-uploader">
                            <span class="input_content" :class="[(discribution.warnState == 1 || discribution.warnState == 3) ? 'red':'',discribution.warnState == 2 ? 'yellow':'']">{{deviceParams.type2}}</span>
                          </div>
                        </div>
                        <div class="grid-content">
                          <span class="input_label">温度阈值:</span>
                          <div class="avatar-uploader">
                            <span class="input_content">{{deviceParams.type130}}</span>
                          </div>
                        </div>
                      </el-col>
                    </el-row>
                    <el-row>
                      <el-col :span="24">
                        <div class="status_steps">
                          <span class="status_title">状态跟踪</span>
          ...
          <remoteoperation @handleClose="remoteOperationClose" :operaObj="operaObj" v-if="remoteOperationShow"/>
...
import wisdomelec from "./wisdomelec.js";
export default wisdomelec;
</script>
<style lang="scss">
@import "./wisdomelec.scss";
