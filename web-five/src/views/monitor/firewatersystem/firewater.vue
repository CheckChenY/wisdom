<template>
  <div class="fire_alarm">
      ...
      <span v-if="type.prop==='tab1'">
        <avue-crud ref="crud"
          ...
          <template slot-scope="scope"
            ...
            <el-button size="mini" type="text" icon="el-icon-setting" @click="remotedoit(scope)" v-if="scope.row.deviceType==26">远程操作</el-button>
          </template>
        </avue-crud>
        <!-- 设备类型弹窗 -->
    ...
    ></device-detail-dialog>
    <deviceremote
      @handleClose="remoteOperationClose"
      :setPropsId="setData"
      v-if="remoteOperationShow"/>
  </div>
</template>

<script>
import firewater from './firewater.js'
export default firewater
</script>

<style lang="scss">
@import './firewater.scss'
</style>
