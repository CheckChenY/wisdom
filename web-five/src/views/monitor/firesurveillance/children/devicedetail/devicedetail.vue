              ...
              <el-row>
                <el-col :span="12">
                  ...
                  <div class="grid-content">
                    ...
                    <div class="avatar-uploader">
                      <span class="input_content">{{device_status[tabOneData.useStatus]}}</span>
                    </div>
                  </div>
                  <div class="grid-content">
          ...
          <el-container class="contain_scroll is-vertical">
            <el-main>
              <el-row>
                <el-col :span="12">
                  <div class="grid-content">
                    ...
                    <div class="avatar-uploader">
                      <span class="input_content">{{currentStatus.time}}</span>
                    </div>
                  </div>
                  <div class="grid-content">
                ...
                <el-col :span="12">
                  <div class="grid-content">
                    ...
                    <div class="avatar-uploader">
                      <span class="input_content" :class="[(discribution.warnState == 1 || discribution.warnState == 3) ? 'red':'',discribution.warnState == 2 ? 'yellow':'']">{{currentStatus.warnState}}</span>
                    </div>
                  </div>
                </el-col>
              </el-row>
              <el-row>
                <!-- <el-col :span="12">
                  <div class="grid-content">
                    <span class="input_label">报警视频截图:</span>
                    <div class="video_img">
                      <div class="avatar-uploader">
                        <img :src="currentStatus.warnPhoto" class="video_img_avatar">
                      </div>
                      <div class="view_button">
                        <el-button @click="showImg(currentStatus.warnPhoto)">查看大图</el-button>
                      </div>
                    </div>
                  </div>
                </el-col> -->
                <el-col :span="24">
                  <div class="current_status">
                    ...
                    <!-- <span class="status_handle" @click="dealWith" v-if="discribution.warnState != 0">前往处理></span> -->
                  </div>
                  <div class="status_steps">
                    <el-steps direction="vertical" :active="RstatusSteps.length">
                      <el-step class="step_style" v-for="(item, i) in RstatusSteps" :key='i' :title="item.time" :description="item.description"></el-step>
                    </el-steps>
                  </div>
                </el-col>
              </el-row>
