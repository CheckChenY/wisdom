    ...
    <div v-if="showindex=='monitoring'">
      ...
      <div class="electric_dialog">
        <div class="electric_look device_dialog">
                  ...
                  <el-main>
                    <el-row>
                      <el-col :span="12">
                        ...
                        <!-- v-if="discribution.deviceType==37 || discribution.deviceType==39" -->
                        <div class="grid-content" v-if="deviceParams.type131">
                          <span class="input_label">电压报警阈值:</span>
                          <div class="avatar-uploader">
                            <span class="input_content">{{deviceParams.type131}}</span>
                          </div>
                        </div>
                         <!-- v-if="discribution.deviceType==39" -->
                        <div class="grid-content" v-if="deviceParams.type132">
                      ...
                      <el-col :span="12">
                        <div class="grid-content">
                         ...
                         <!-- v-if="discribution.deviceType==37" -->
                        <div class="grid-content" v-if="deviceParams.type3">
                        ...
                        <!-- v-if="discribution.deviceType==39" -->
                        <div class="grid-content" v-if="deviceParams.type4">
                  ...
                  <el-main>
                    <el-row>
                      <el-col :span="24">
                        ...
                        <div id="echartLines" v-if="deviceParams.type3" class="chart_style"></div>
                        <div id="echartLinesEle" v-if="deviceParams.type4" class="chart_style"></div>
                      </el-col>
                    </el-row>
                  </el-main>
                </el-container>
          ...
          <remoteoperation @handleClose="remoteOperationClose" v-if="remoteOperationShow" :setPropsId="setData.row"/>
...
<style lang="scss">
@import "./firepower.scss";
@import "./childern/devicedetail.scss";
</style>