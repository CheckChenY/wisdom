    ...
    <div v-if="showindex=='monitoring'">
      ...
      <div class="electric_dialog">
        <div class="electric_look device_dialog">
                    ...
                    <el-row>
                      <el-col :span="12">
                        ...
                        <div class="grid-content">
                          ...
                          <div class="avatar-uploader">
                            <span class="input_content">{{tabOneData.useStatus}}</span>
                          </div>
                        </div>
                        <div class="grid-content">
                  ...
                  <el-main>
                    <el-row>
                      <el-col :span="12">
                        ...
                        <div class="grid-content">
                          <span class="input_label">四项温度:</span>
                          <div class="avatar-uploader">
                            <span class="input_content"></span>
                          </div>
                        </div>
                      ...
                      <el-col :span="12">
                        <div class="grid-content">
                          ...
                          <div class="avatar-uploader">
                            <span class="input_content" :class="[(discribution.warnState == 1 || discribution.warnState == 3) ? 'red':'',discribution.warnState == 2 ? 'yellow':'']">{{discribution.warnState}}</span>
                          </div>
                        </div>
                        <div class="grid-content">
          ...
          <remoteoperation @handleClose="remoteOperationClose" v-if="remoteOperationShow" :setPropsId="setData"/>
...
import firedoorindex from "./fierdoor.js";
export default firedoorindex;
</script>
<style lang="scss">
@import "./firedoor.scss";
