    ...
    render() {
        ...
        <View  style={[styles.container,{marginTop: isFull ? 0 :  40 }]}>
            ...
            <ScrollView
                ...
                >
            <Text style={{marginTop:10}}>m3u8</Text>
            <VlcSimplePlayer
                //http://39.108.213.89:8091/hls/c844150006c9.m3u8
                //rtmp://39.108.213.89:1935/live/c844150006c9
                url={"http://39.108.213.89:8091/hls/c844150006c9.m3u8"}
                isLive={true}
                autoReloadLive={true}
            ...
            {/* <Text style={{marginTop:20}}>广告、标题示例  rtmp</Text>
            <VlcSimplePlayer
                // url={"rtmp://39.108.213.89:1935/live/c844150006c9"}
                // Orientation={Orientation}
                style={{width:'80%'}}
                onStartFullScreen={this.onStartFullScreen}
                onCloseFullScreen={this.onCloseFullScreen}
                showAd={true}
                reloadWithAd={true}
                adUrl={require('rtmp://39.108.213.89:1935/live/c844150006c9')}
                showTop={true}
                showBack={true}
            ...
            <Text style={{marginTop:20}}>rtmp</Text>
            <VlcSimplePlayer
                style={{width:'80%'}}
                url={"rtmp://39.108.213.89:1935/live/c844150006c9"}
                //Orientation={Orientation}
