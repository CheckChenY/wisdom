...
// const unitUrl = "http://192.168.0.186:5001/jtl"

// const unitUrl = "http://1.192.212.139:25001/jtl"//外网
// const unitUrl = "http://1.192.212.139:25001/jtl"//外网
// const camera = 'http://192.168.0.155:20016/inner/jtlDeviceCamera/insert'


const unitUrl = "http://192.168.0.189:5001/jtl"

// const unitUrl = "http://47.105.104.28:6000"//基础信息
// const unitUrl = "http://192.168.0.61:800"//李宵雨
// const unitUrl = "http://192.168.0.155:8088"//刘丹
// const unitUrl = "http://192.168.0.127:800"//吴鑫
// const unitUrl = "http://192.168.0.20:800"//罗
...
export default class FetchManager {
     ...
     *  callback:回调函数
     * */
    static get = async (url,params,callback,type) =>{
        let token = await AsyncStorage.getItem('access_token');
        // let token = '057e6d2e-cd29-4335-abcb-52892815ac6a';
        console.log(token)
        let unit = unitUrl;
        if(type === 'liu'){
            unit = 'http://192.168.0.155:20019'
        }else if(type === 'wu'){
            unit = 'http://192.168.0.127:20020'
        }
        if (params) {
            let paramsArray = [];
            //拼接参数
    ...
    static postLogin = async (url,params,callback) =>{
        ...
        fetch(unitUrl + url ,{
            method: 'POST',
            headers: {
                'Authorization': 'Basic dW5pdHktY2xpZW50OnVuaXR5',
                'Accept': 'application/json',
                'Content-Type': 'application/json',
            },
     ...
     *  callback:回调函数
     * */
    static post = async (url,params,callback,type) => {
        let token = await AsyncStorage.getItem('access_token')
        let unit = unitUrl
        if(type === 'camera'){
            // unit = 'http://192.168.0.155:20012'
            unit = 'http://192.168.0.135:20012'
        }else if(type === 'wu'){
            unit = 'http://192.168.0.127:20020'
        }else if(type === 'cao'){
            unit = 'http://192.168.0.56:8186'
        }else if(type === 'liu'){
            unit = 'http://192.168.0.155:20010'
        }else if(type === 'kua'){
            unit = 'http://192.168.0.56:20020'
        }
        //fetch请求
        console.log(unit + url)
        fetch(unit + url ,{
    ...
    static getTimeOut = async (url,params,callback,type) => {
        let token = await AsyncStorage.getItem('access_token')
...
export const encryptionpwd = (params) => {
    // let {
    //     data,
    //     type,
    //     param,
    ...
    // } else {
        // param.forEach(ele => {
            ...
            key = CryptoJS.enc.Latin1.parse(params)
            debugger;
            let iv = key
            // 加密
            let encrypted = CryptoJS.AES.encrypt(
            ...
            result[params] = encrypted.toString()
        // })
    // }
    let str = result.password;
    result.password = str.replace(/[+]/g,'%2B')
