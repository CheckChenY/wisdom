...
export default class HomeView extends Component {
    ...
    componentDidMount(){
        ...
        const {id,companyId} = this.props.navigation.state.params;
        ...
        return (
            <View>
                ...
                <View style={styles.containerLine}>
                    ...
                    <View style={styles.containerLine}>
                        <Text style={styles.title}>操作用户：</Text>
                        <Text style={styles.content}>{item.operatorName}</Text>
                    </View>
                    <View style={styles.containerLine}>
                        <Text style={styles.title}>操作详情：</Text>
                        <Text style={styles.content}>{item.operationDetails}</Text>
                    </View>
                </View> 
    ...
    _getHotList(list) {
        const { data } = this.state;
        console.log(list)
        FetchManager.get('/alarm/inner/jtlAlarmLinkLog/getLinkLogByAlarmId',list, async (set) => {
            // debugger;
            console.log(set)
            //下面的就是请求来的数据
