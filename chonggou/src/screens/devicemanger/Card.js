...
export default class HomeView extends Component {
    ...
    constructor(props){
        ...
        this.state = {
            ...
            // 加载更多
            isLoadMore:true,
            term:[{label:'服务期限(全部)',value:0},{label:'有效期',value:1},{label:'已过期',value:2}],
            system:[],
    ...
    componentDidMount(){
        const { system,list,obj } = this.state;
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.rightContainer}>
                        ...
                        <View style={styles.containerLine}>
                            ...
                            <Text style={styles.content}>{item.expirationDate}</Text>
                        </View>
                        <View style={styles.containerLine}>
            ...
            if(set&&set.success){
                if(this.page === 0){
                    ...
                    this.setState({
                        ...
                        isLoadMore : false,
                        // 数据源刷新 add
                        data: this.state.data.concat(set.value.content)
                    })
                }
            }else{
                // this._signOut();
