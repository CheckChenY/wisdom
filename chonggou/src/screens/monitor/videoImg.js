...
class CaseImage extends Component{
    ...
    componentDidMount (){
        ...
        this.setState({
            modelPhoto:'http://192.168.0.186:60080/'+data.modelPhoto,
            surroundingPhoto:'http://192.168.0.186:60080/'+data.surroundingPhoto,
            left:l,
            tops:t,
            // bol:true
        })
    ...
    render(){
        const { modelPhoto,surroundingPhoto,left,tops,bol } = this.state;
        console.log(bol)
        return(
