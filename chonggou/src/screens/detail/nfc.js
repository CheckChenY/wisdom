...
//                                 <Text style={{color: 'blue'}}>{`(android) ${isWriting ? '取消' : '写入NDEF'}`}</Text>
//                             </TouchableOpacity>

//                             <TouchableOpacity 
//                                 style={{ marginTop: 20, borderWidth: 1, borderColor: 'blue', padding: 10 }} 
//                                 onPress={isWriting ? this._cancelNdefWrite : this._requestFormat}>
//                                 <Text style={{color: 'blue'}}>{`(android) ${isWriting ? '取消' : '格式'}`}</Text>
//                             </TouchableOpacity>

//                             <TouchableOpacity 
//                                 style={{ marginTop: 20, borderWidth: 1, borderColor: 'blue', padding: 10 }} 
//                                 onPress={isWriting ? this._cancelAndroidBeam : this._requestAndroidBeam}>
//                                 <Text style={{color: 'blue'}}>{`${isWriting ? '取消 ' : ''}Android Beam`}</Text>
//                             </TouchableOpacity>
//                         </View>
//                     }

//                     <Text style={{ marginTop: 20 }}>{`Current tag JSON: ${JSON.stringify(tag)}`}</Text>
//                     { parsedText && <Text style={{ marginTop: 10, marginBottom: 20, fontSize: 18 }}>{`解析文本: ${parsedText}`}</Text>}
//                 </View>
//             </ScrollView>
//         )
//     }
