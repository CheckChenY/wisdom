...
export function findPageListAndIsAdmin (obj) {
    return request({
        url: '/menu/inner/jtlRole/findPageListAndIsAdmin',
        method: 'get',
        params: obj
    })
}
...
export function findMenuCodeByUserId (obj) {
    return request({
        url: '/menu/inner/jtlRole/findMenuCodeByUserId',
        method: 'get',
        params: obj
    })
}