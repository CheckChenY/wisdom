<template>
    <div class="menu_header">
        <div style="width:65%;height:100%;display:flex;align-items:center;">
            <img style="height:18px;padding:0 5px;" :src="orgObj.logo">
            <!-- <img class="home_sys_name" v-if="!isCollapse" src="/img/name.png"> -->
            <span style="font-size: 18px;color:#fff;">{{orgObj.orgName}}</span>
        </div>
        <div style="width:35%;display: flex;justify-content: flex-end;align-items:center;padding:0 10px;">
            ...
            <div class="icons-list" @click="toWorkplatform">
                <a-badge>
                    <i class="icon-gongzuotai" style="font-size:24px;"></i>
                </a-badge>
            </div>
            <div class="icons-list" @click="toAlarm">
                <a-badge :count="alarmSituationCount" :numberStyle="{boxShadow: '0 0 0 0 inset'}" >
