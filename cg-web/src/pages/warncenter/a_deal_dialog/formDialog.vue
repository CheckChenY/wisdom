        ...
        <a-drawer
            ...
            <a-tabs @change="onTabChange" :activeKey="activeKey" style="margin-top:-10px;">
                <a-tab-pane tab="警情信息" key="1">
                    <tab1 :warnnum="activeKey" :visible="visible" :record="record" @handleOk='handleOk'></tab1>
                </a-tab-pane>
                <a-tab-pane tab="报警数据" key="2">
                    <tab2 :warnnum="activeKey" :record="record"></tab2>
                </a-tab-pane>
                <a-tab-pane tab="相关图片" key="3">
                    <tab3 :warnnum="activeKey" :visible="visible" :record="record"></tab3>
                </a-tab-pane>
                <a-tab-pane tab="关联视频" key="4">
                    <tab4 :warnnum="activeKey" :record="record"></tab4>
                </a-tab-pane>
