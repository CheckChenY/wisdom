...
import chargingpileDialog from './chargingpileDialog.vue';
import chargingpileRemote from './chargingpileRemote.vue';
import chargingpileThresold from './chargingpileThresold.vue';
...
export default {
    ...
    methods:{
        ...
        onView(record) {
            this.$refs.chargingpileDialog.showDrawer(record)
        },
        onThresold(record){
        ...
        closeModal(record, value) {
            if (value == 'Thresold') {
                this.$refs.chargingpileThresold.showDrawer(record)
            } else if (value == 'Remote'){
                this.$refs.chargingpileRemote.showDrawer(record)
            }
        },
        rowClassName (record) {
            let className = '';
