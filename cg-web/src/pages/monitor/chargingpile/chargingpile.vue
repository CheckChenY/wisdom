<template>
    <div class="monitor_body">
        ...
        <chargingpileDialog ref="chargingpileDialog"></chargingpileDialog>
        <chargingpileRemote ref="chargingpileRemote"></chargingpileRemote>
        <chargingpileThresold ref="chargingpileThresold"></chargingpileThresold>
        <checkmodal ref="checkmodal" @closeModal="closeModal"></checkmodal>
    </div>
</template>
<script src="./chargingpile.js"></script>
<style lang="scss">
</style>
