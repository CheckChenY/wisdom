<template>
    <div class="monitor_body">
        ...
        <firewirelessDialog ref="firewirelessDialog"></firewirelessDialog>
        <firewirelessRemote ref="firewirelessRemote"></firewirelessRemote>
        <checkmodal ref="checkmodal" @closeModal="closeModal"></checkmodal>
    </div>
</template>
<script src="./firewireless.js"></script>
<style lang="scss">
</style>
