<template>
    <div class="monitor_body">
        ...
        <firepowerDialog ref="firepowerDialog"></firepowerDialog>
        <firepowerRemote ref="firepowerRemote"></firepowerRemote>
        <firepowerThresold ref="firepowerThresold"></firepowerThresold>
        <checkmodal ref="checkmodal" @closeModal="closeModal"></checkmodal>
    </div>
</template>
<script src="./firepower.js"></script>
<style lang="scss">
</style>
