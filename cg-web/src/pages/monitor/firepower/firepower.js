...
import firepowerDialog from './firepowerDialog.vue';
import firepowerRemote from './firepowerRemote.vue';
import firepowerThresold from './firepowerThresold.vue';
...
export default {
    ...
    methods:{
        getDictData(){
            getDeviceFindList({type:2,id:'1574920051749469'}).then(res=>{
                this.deviceTypeList=[]
        ...
        onView(record) {
            this.$refs.firepowerDialog.showDrawer(record)
        },
        onThresold(record){
        ...
        closeModal(record, value) {
            if (value == 'Thresold') {
                this.$refs.firepowerThresold.showDrawer(record)
            } else if (value == 'Remote'){
                this.$refs.firepowerRemote.showDrawer(record)
            }
        },
        rowClassName (record) {
            let className = '';
