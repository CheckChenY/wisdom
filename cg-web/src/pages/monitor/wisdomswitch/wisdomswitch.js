...
import wisdomswitchDialog from './wisdomswitchDialog.vue';
import wisdomswitchRemote from './wisdomswitchRemote.vue';
import wisdomswitchThresold from './wisdomswitchThresold.vue';
...
export default {
    ...
    methods:{
        ...
        onView(record) {
            this.$refs.wisdomswitchDialog.showDrawer(record)
        },
        onThresold(record){
        ...
        closeModal(record, value) {
            if (value == 'Thresold') {
                this.$refs.wisdomswitchThresold.showDrawer(record)
            } else if (value == 'Remote'){
                this.$refs.wisdomswitchRemote.showDrawer(record)
            }
        },
        rowClassName (record) {
            let className = '';
