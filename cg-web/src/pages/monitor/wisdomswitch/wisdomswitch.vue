<template>
    <div class="monitor_body">
        ...
        <wisdomswitchDialog ref="wisdomswitchDialog"></wisdomswitchDialog>
        <wisdomswitchRemote ref="wisdomswitchRemote"></wisdomswitchRemote>
        <wisdomswitchThresold ref="wisdomswitchThresold"></wisdomswitchThresold>
        <checkmodal ref="checkmodal" @closeModal="closeModal"></checkmodal>
    </div>
</template>
<script src="./wisdomswitch.js"></script>
<style lang="scss">
</style>
