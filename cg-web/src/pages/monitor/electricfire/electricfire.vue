<template>
    <div class="monitor_body">
        ...
        <electricfireDialog ref="electricfireDialog"></electricfireDialog>
        <electricfireRemote ref="electricfireRemote"></electricfireRemote>
        <electricfireThresold ref="electricfireThresold"></electricfireThresold>
        <checkmodal ref="checkmodal" @closeModal="closeModal"></checkmodal>
    </div>
</template>
<script src="./electricfire.js"></script>
<style lang="scss">
</style>
