...
import electricfireDialog from './electricfireDialog.vue';
import electricfireRemote from './electricfireRemote.vue';
import electricfireThresold from './electricfireThresold.vue';
...
export default {
    ...
    methods:{
        ...
        onView(record) {
            this.$refs.electricfireDialog.showDrawer(record)
        },
        onThresold(record){
        ...
        closeModal(record, value) {
            console.log(value)
            if (value == 'Thresold') {
                this.$refs.electricfireThresold.showDrawer(record)
            } else if (value == 'Remote'){
                this.$refs.electricfireRemote.showDrawer(record)
            }
        },
        rowClassName (record) {
            let className = '';
