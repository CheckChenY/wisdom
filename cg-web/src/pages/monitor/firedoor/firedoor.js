...
import firedoorDialog from './firedoorDialog.vue';
import firedoorRemote from './firedoorRemote.vue';
...
export default {
    ...
    methods:{
        ...
        onView(record) {
            this.$refs.firedoorDialog.showDrawer(record)
        },
        handleSearch(e) {
            e.preventDefault();
        ...
        closeModal(record, value) {
            console.log(value)
            if (value == 'Remote'){
                this.$refs.firedoorRemote.showDrawer(record)
            }
        },
        rowClassName (record) {
            let className = '';
