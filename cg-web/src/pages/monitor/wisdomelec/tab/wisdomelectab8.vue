...
export default {
    ...
    mounted () {
        ...
        this.lineCharts("echartLines", "三相电压变化曲线", lineList1, ['1-1','1-2','1-3','1-4','1-5'], resName1, resColor1, '电压:V')
        this.lineCharts("echartLinesEle", "三相电流变化曲线", lineList2, ['1-1','1-2','1-3','1-4','1-5'], resName2, resColor2, '电流:A')
        this.lineCharts("echartLinesOne", "漏电变化曲线", lineList1, ['1-1','1-2','1-3','1-4','1-5'], resName3, resColor3, '漏电:mA')
        this.lineCharts("echartLinesEleTwo", "三相四线温度变化曲线", lineList2, ['1-1','1-2','1-3','1-4','1-5'], resName4, resColor4, '温度:℃')
    },
    computed: {
    },
    beforeCreate() {
