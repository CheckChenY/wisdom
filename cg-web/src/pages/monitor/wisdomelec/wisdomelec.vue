<template>
    <div class="monitor_body">
        ...
        <wisdomelecDialog ref="wisdomelecDialog"></wisdomelecDialog>
        <wisdomelecRemote ref="wisdomelecRemote"></wisdomelecRemote>
        <wisdomelecThresold ref="wisdomelecThresold"></wisdomelecThresold>
        <checkmodal ref="checkmodal" @closeModal="closeModal"></checkmodal>
    </div>
</template>
<script src="./wisdomelec.js"></script>
<style lang="scss">
</style>
