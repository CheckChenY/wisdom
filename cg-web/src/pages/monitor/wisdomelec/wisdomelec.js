...
import wisdomelecDialog from './wisdomelecDialog.vue';
import wisdomelecRemote from './wisdomelecRemote.vue';
import wisdomelecThresold from './wisdomelecThresold.vue';
...
export default {
    ...
    methods:{
        getDictData(){
            getDeviceFindList({type:2,id:'1574920051750940'}).then(res=>{
                this.deviceTypeList=[]
        ...
        onView(record) {
            this.$refs.wisdomelecDialog.showDrawer(record)
        },
        onThresold(record){
        ...
        closeModal(record, value) {
            if (value == 'Thresold') {
                this.$refs.wisdomelecThresold.showDrawer(record)
            } else if (value == 'Remote'){
                this.$refs.wisdomelecRemote.showDrawer(record)
            }
        },
        rowClassName (record) {
            let className = '';
