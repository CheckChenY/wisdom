<template>
    <div class="monitor_body">
        ...
        <firecockDialog ref="firecockDialog"></firecockDialog>
        <firecockRemote ref="firecockRemote"></firecockRemote>
        <firecockThresold ref="firecockThresold"></firecockThresold>
        <checkmodal ref="checkmodal" @closeModal="closeModal"></checkmodal>
    </div>
</template>
<script src="./firecock.js"></script>
<style lang="scss">
</style>
