...
import firecockDialog from './firecockDialog.vue';
import firecockRemote from './firecockRemote.vue';
import firecockThresold from './firecockThresold.vue';
...
export default {
    ...
    methods:{
        getDictData(){
            getDeviceFindList({type:2,id:'1574920051744145'}).then(res=>{
                this.deviceTypeList=[]
        ...
        onView(record) {
            this.$refs.firecockDialog.showDrawer(record)
        },
        onThresold(record){
        ...
        closeModal(record, value) {
            if (value == 'Thresold') {
                this.$refs.firecockThresold.showDrawer(record)
            } else if (value == 'Remote'){
                this.$refs.firecockRemote.showDrawer(record)
            }
        },
        rowClassName (record) {
            let className = '';
